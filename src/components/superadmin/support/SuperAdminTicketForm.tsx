...
import { useCreateSuperadminSupportTicket, useUpdateSuperadminSupportTicket, CreateTicketData, UpdateTicketData, SupportTicket } from '@/hooks/useSuperadminSupportTickets';
import { useToast } from '@/hooks/useToast';
import { SuperAdminAttachmentUploader, AttachmentFile } from './SuperAdminAttachmentUploader';
import Link from 'next/link';

interface SuperAdminTicketFormProps {
  ticket?: SupportTicket;
  mode: 'create' | 'edit';
  className?: string;
}

export const SuperAdminTicketForm: React.FC<SuperAdminTicketFormProps> = ({
  ticket,
  mode,
  className = ''
}) => {
  ...
  const createTicketMutation = useCreateSuperadminSupportTicket();
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-end gap-4">
          ...
          >
            ...
            {isSubmittingAny ? 'Saving...' : mode === 'create' ? 'Create Ticket' : 'Update Ticket'}
          </button>
        </div>
      </form>
    </div>
