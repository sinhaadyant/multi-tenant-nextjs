...
test.describe("Login Page", () => {
  ...
  test.describe("Successful Login Scenarios", () => {
    ...
    test("should successfully login with tenant slug", async ({ page }) => {
      ...
      await page.getByLabel("Email").fill(tenantAdmin.email);
      await page.getByLabel("Password").fill(tenantAdmin.password);
      await page.getByLabel("Tenant (Optional)").fill("tenant-a");
    ...
    test("should successfully login with remember me checked", async ({ page }) => {
      await page.goto("/login");
  ...
  test.describe("Form Validation Errors", () => {
    ...
    test("should show error for very long password", async ({ page }) => {
      ...
      // Should show validation error
      await testUtils.expectFormValidationError("Password", "Password too long");
    });
  ...
  test.describe("Authentication Errors", () => {
    test("should show error for non-existent user", async ({ page }) => {
      ...
      const invalidCreds = credentialsHelper.getInvalidCredentials("nonExistentUser");
      
      // Fill in non-existent user credentials
      await page.getByLabel("Email").fill(invalidCreds.email);
      await page.getByLabel("Password").fill(invalidCreds.password);
    ...
    test("should show error for wrong password", async ({ page }) => {
      ...
      // Get invalid credentials
      const invalidCreds = credentialsHelper.getInvalidCredentials("wrongPassword");
