...
async function testAllAPIs() {
  ...
  console.log('🧪 Testing All SuperAdmin APIs...\n');

  // Test cases for all major endpoints
  const testCases = [
    // ===== TENANT MANAGEMENT =====
    {
      ...
      tests: [
        ...
        },
        {
          ...
          url: `${baseURL}/tenants?page=1&limit=10&sortBy=name&sortOrder=desc`,
          method: 'GET'
        },
        {
        ...
        },
        {
          ...
          url: `${baseURL}/tenants?page=1&limit=10&sortBy=status&sortOrder=desc`,
          method: 'GET'
        },
        {
        ...
        {
          name: 'Sort by userCount descending',
          url: `${baseURL}/tenants?page=1&limit=10&sortBy=userCount&sortOrder=desc`,
          method: 'GET'
        },
        {
          name: 'Sort by createdAt ascending',
          url: `${baseURL}/tenants?page=1&limit=10&sortBy=createdAt&sortOrder=asc`,
          method: 'GET'
        },
        {
          name: 'Sort by createdAt descending',
          url: `${baseURL}/tenants?page=1&limit=10&sortBy=createdAt&sortOrder=desc`,
          method: 'GET'
        },
        {
          name: 'Search tenants',
        ...
        },
        {
          ...
          url: `${baseURL}/tenants?page=1&limit=10&status=inactive`,
          method: 'GET'
        },
        {
        ...
        {
          name: 'Filter by plan pro',
          url: `${baseURL}/tenants?page=1&limit=10&plan=pro`,
          method: 'GET'
        },
        {
          name: 'Filter by region',
          url: `${baseURL}/tenants?page=1&limit=10&region=us-east-1`,
          method: 'GET'
        },
        {
    ...
    // ===== NOTIFICATIONS =====
    {
      ...
      tests: [
        ...
        },
        {
          ...
          url: `${baseURL}/notifications?page=1&limit=10&sortBy=title&sortOrder=asc`,
          method: 'GET'
        },
        {
          name: 'Sort by createdAt descending',
        ...
        },
        {
          ...
          url: `${baseURL}/notifications?page=1&limit=10&priority=high`,
          method: 'GET'
        },
        {
        ...
        {
          name: 'Notification read endpoint',
          url: `${baseURL}/notifications/test-id/read`,
          method: 'PATCH'
        },
        {
          name: 'Notification status endpoint',
          url: `${baseURL}/notifications/test-id/status`,
          method: 'PATCH',
          data: { isActive: true }
        }
      ]
    ...
    // ===== USERS =====
    {
      ...
      tests: [
        ...
        },
        {
          ...
          url: `${baseURL}/users?page=1&limit=10&sortBy=email&sortOrder=asc`,
          method: 'GET'
        },
        {
          name: 'Filter by status active',
    ...
    // ===== UTILITY ENDPOINTS =====
    {
      ...
      tests: [
        ...
        {
          name: 'Export notifications CSV',
          url: `${baseURL}/notifications/export?format=csv`,
          method: 'GET'
        },
        {
          name: 'Export audit logs CSV',
          url: `${baseURL}/audit-logs/export?format=csv`,
          method: 'GET'
        }
      ]
    }
      ...
      try {
        ...
        const config = {
          ...
          headers: {
            ...
            // Note: No auth token provided for testing
          },
          timeout: 10000
        };
        ...
        if (error.response?.status === 401) {
          ...
          console.log(`✅ Expected: Not found (invalid ID)`);
          notFoundErrors++;
          passedTests++; // This is expected behavior
  ...
  console.log(`🔒 Auth Errors (Expected): ${authErrors}`);
